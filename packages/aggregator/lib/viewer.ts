...
import { UniswapV2Viewer, UniswapV3Viewer } from "../typechain-types";
...
export class UniswapV3ViewerLib extends ViewerLib {
  ...
  constructor(
    ...
    super(prvider, multicallChunkLength, chunckedMulticallConcurrency, limit);
    this.contract = new ethers.Contract(address, UniswapV3ViewerArtifact.abi, prvider) as UniswapV3Viewer;
